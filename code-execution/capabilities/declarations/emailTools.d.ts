/**
 * @note This is the type declaration file of the "@tools/emailTools" module.
 *
 * Import the exported items for this module using the following syntax @example
 * @example
 * ```ts
 * import { ... } from "@tools/emailTools";
 * ```
 */
